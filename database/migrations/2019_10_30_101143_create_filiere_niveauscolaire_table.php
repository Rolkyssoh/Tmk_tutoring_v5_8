...
class CreateFiliereNiveauscolaireTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('filiere_niveauscolaire', function (Blueprint $table) {
            $table->engine="InnoDB";
    ...
    {
        Schema::dropIfExists('filiere_niveauscolaire');
    }
}
